...
//#pass type=forward name=stencil blend=off zwrite=material(off) ztest=material_unity(main) cull=material(front) color_mask=material(rgba) offset=material(0,0) stencil=material
@fragment
